...
public class SearchRewardsTC {
	...
	public static void fluentWait(By loc, WebDriver driver) {
		WebElement elemVer = (new WebDriverWait(driver, 20)).until(ExpectedConditions.presenceOfElementLocated(loc));
